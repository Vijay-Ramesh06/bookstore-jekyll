...
**CRUD**
Create, Read, Update, Delete â€” the four basic operations supported by the API for each resource type.
...
**Review**
A customer rating and comment for a book, with a 1â€“5 star rating and optional title and body text.
